    ...
    render() {
        ...
        return (
            <div className="pure-control-group">
                ...
                <input min={this.props.min} max={this.props.max} step={this.props.step} id={this.props.id} type={this.props.type} name={this.props.name} value={this.props.value} onChange={this.props.onChange} />
